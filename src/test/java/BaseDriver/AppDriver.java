	     ...
	     @BeforeTest
	      public void Initialize() throws Exception {
	    	 DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss");  
	    	   ...
	    	   htmlreporter = new ExtentHtmlReporter("D:\\Software\\Phantom_workspace\\AppiumAutomation\\Reports\\apkresult.html");
	    	  ...
	    	  FileInputStream fis = new FileInputStream("D:\\Software\\Phantom_workspace\\AppiumAutomation\\src\\test\\java\\property\\config.properties");
	    	  config.load(fis);
